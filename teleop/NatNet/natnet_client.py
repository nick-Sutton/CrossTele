...
class NatNetClient:
    ...
    def __init__(self):
        ...
        # file path to natnet config file
        self.config_path = "../../config/natnet_config.yaml"

        # Dictionary Containing config data
        self.config = NatNetParser.parse_config_file(self.config_path)

        # Change this value to the IP address of the NatNet server.
        self.server_ip_address = self.config['server_address']

        # Change this value to the IP address of your local network interface
        self.local_ip_address = self.config['local_address']

        # Should match multicast address listed in Motive's streaming settings.
        self.multicast_address = self.config['multicast_address']

        if self.config['connection_type'] == "Unicast":
            self.use_multicast = False
        elif self.config['connection_type'] == "Multicast":
